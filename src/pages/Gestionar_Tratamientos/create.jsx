...
export default function CrearTratamiento() {
  ...
  useEffect(() => {
    // Asegúrate de usar el endpoint correcto y que apiClient incluya el token de usuario
  ...
  function handleSubmit(data) {
    setLoading(true);
    setError("");
    api.post("/diagnosticos/tratamientos/", data)
      .then(() => {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Registra un nuevo tratamiento en el sistema</p>
            </div>
          </div>
        </div>
        ...
        {error && (
          <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-xl flex items-center gap-3">
            ...
            <div>
              <h3 className="text-red-800 font-semibold">Error al crear tratamiento</h3>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 bg-gradient-to-r from-blue-50 to-white border-b border-gray-200">
            <h2 className="text-xl font-bold text-gray-900">Información del Tratamiento</h2>
